...
//******************************
    ...
    public void addData(Cursor cursor) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                long id = cursor.getLong(MovieContract.MovieData.COL_MOVIE_ID);
                String v_average = cursor.getString(MovieContract.MovieData.COL_MOVIE_VOTE_AVERAGE);
                String title = cursor.getString(MovieContract.MovieData.COL_MOVIE_TITLE);
                String backdropPath = cursor.getString(MovieContract.MovieData.COL_MOVIE_BACKDROP_PATH);
                String overview = cursor.getString(MovieContract.MovieData.COL_MOVIE_OVERVIEW);
                String releaseDate = cursor.getString(MovieContract.MovieData.COL_MOVIE_RELEASE_DATE);
                String posterPath = cursor.getString(MovieContract.MovieData.COL_MOVIE_POSTER_PATH);
